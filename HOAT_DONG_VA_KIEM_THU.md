...
**Hành vi dẫn hướng:**
- [ ] Dấu + luôn cố định giữa màn hình khi bật ⊹; nốt tròn xuất hiện khi có
      chủ thể. Di máy về phía nốt → nốt tiến dần về dấu +; khi trùng:
      **chuyển xanh + rung nhẹ + vòng xác nhận**, nốt biến mất.
- [ ] Nốt tròn nằm ngoài khung nhìn → bị ghim ở mép đúng phía cần di máy.
- [ ] Vật thể to chiếm gần hết khung → nốt dẫn về tâm (trùng ngay dấu +
      khi vật đã căn giữa).
- [ ] Nhiều vật thể: app tự chọn vật to/gần tâm; **long-press** lên vật khác
      → nốt chuyển **vàng**, bám theo vật đó kể cả khi di máy;
      long-press vùng trống → bỏ khoá.
- [ ] Không có vật thể rõ (tường trắng) → chỉ còn dấu +, nốt tự ẩn,
      không nhấp nháy loạn.
